  ...
  <div class="wrap">
    <div class="menu-title">
          ...
          <img
            :src="
              showRegistrationForm
                ? 'client/resources/img/up.png'
                : 'client/resources/img/down.png'
            "
            alt="Toggle Icon"
          />
        </button>
      ...
      <div class="search-section">
        ...
        <!-- 작성일 선택 시 날짜 선택기 표시 -->
        <input
          v-if="selectedSearchOption === 'product_date'"
          type="date"
    ...
    <div class="menu" v-show="showRegistrationForm">
        ...
        <ul>
          ...
          <li class="menu-content-category">
            ...
            <label for="frappuccino">
              <img
                src="client/resources/img/frappuccino.png"
                alt="Frappuccino"
              />
              프라푸치노
              <input
          ...
          <li class="menu-content-sub">
            ...
            <input
              ...
              v-model="newData.product_writer"
            />
          </li>
          <li>
            <span>상세설명</span>
      ...
      <div class="menu-button">
        <button class="button" id="addBtn" @click="handleButtonAction()">
          등록
        </button>
      ...
      <table cellspacing="0">
        ...
        <tbody>
          ...
          >
            ...
            <td>
              <img
                v-show="item.product_category === 'ameriano'"
                src="client/resources/img/americano_icon.png"
                alt="Americano"
              />
              <img
                v-show="item.product_category === 'cafelatte'"
                src="client/resources/img/cafe_latte_icon.png"
                alt="Cafelatte"
              />
              <img
                v-show="item.product_category === 'ade'"
                src="client/resources/img/ade_icon.png"
                alt="Ade"
              />
              <img
                v-show="item.product_category === 'smoothie'"
                src="client/resources/img/smoothie_icon.png"
                alt="Smoothie"
              />
              <img
                v-show="item.product_category === 'frappuccino'"
                src="client/resources/img/frappuccino_icon.png"
                alt="Frappuccino"
              />
              <img
                v-show="item.product_category === 'coke'"
                src="client/resources/img/coke_icon.png"
                alt="Coke"
              />
            </td>
            ...
            <td>
              ...
              <button class="button" @click="dataDelete(item.product_index)">
                삭제
              </button>
            </td>
          </tr>
...
export default {
  ...
  methods: {
    ...
    dataInsert: function () {
      ...
      // 필수 필드 검사
      if (
        !vm.newData.product_name ||
        !vm.newData.product_category ||
        !vm.newData.product_price ||
        !vm.newData.product_writer
      ) {
