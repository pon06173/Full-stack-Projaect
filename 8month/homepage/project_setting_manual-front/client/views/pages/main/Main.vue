<template>
    <div>
        <div class="slideshow-container" v-on:mouseover="pauseSlide" v-on:mouseout="resumeSlide">
            <div class="image-wrapper" :style="{ transform: `translateX(-${currentSlide * 100}%)` }" ref="imageWrapper">
                <img v-for="(imgSrc, index) in images" :key="index" :src="imgSrc" class="slide-image" />
            </div>
        ...
        <div class="item_1_i">
            <div class="item_1">
                <div class="dotstyle">
                    <span v-for="(image, index) in totalImages" :key="index" class="dot"
...
export default {
    data() {
        return {
            ...
            images: [ // 이미지 경로 배열로 관리
                'client/resources/jpg/kopi.jpg',
                'client/resources/jpg/main2.png',
                'client/resources/jpg/main3.png',
                'client/resources/jpg/main5.png'
            ],
        ...
        move(step) {
            ...
            if (step === 1 && this.currentSlide === this.totalImages - 1) {
                ...
                this.animateTransition(() => {
                    ...
                    this.$refs['imageWrapper'].style.transform = `translateX(-${(this.totalImages - 1) * 100}%)`;
                }, true);
            } else {
                this.currentSlide = (this.currentSlide + step + this.totalImages) % this.totalImages;
            }
