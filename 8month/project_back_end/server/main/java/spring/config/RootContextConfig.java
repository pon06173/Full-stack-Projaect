...
public class RootContextConfig {
    ...
    public HikariConfig getMainHikariConfig () {
        ...
        hikariConfig.setJdbcUrl("jdbc:mariadb://localhost:3333/test");
    ...
    private static class Configuration extends org.apache.ibatis.session.Configuration {
    ...
    public SqlSessionTemplate getMainSqlSessionTemplate (ApplicationContext applicationContext) throws Exception {
        return new SqlSessionTemplate(getMainSqlSessionFactory(applicationContext));
    }
