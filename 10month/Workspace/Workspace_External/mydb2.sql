-- create database mydb2 character set utf8mb4 collate utf8mb4_general_ci;
-- use mydb2;
...
-- INSERT INTO `employee` (`employeeID`, `lastname`, `firstname`, `birthdate`, `photo`, `notes`) VALUES
...
-- INSERT INTO `order` (`orderid`, `customerid`, `employeeid`, `orderdate`, `shipperid`) VALUES
...
-- INSERT INTO `order_detail` (`orderdetailid`, `orderid`, `productid`, `quantity`) VALUES
-- (1, 10248, 11, 12),
-- (2, 10248, 42, 10),
-- (3, 10248, 72, 5),
-- (4, 10249, 14, 9),
...
use mydb2;
-- SELECT * FROM category CROSS JOIN customer;
...
-- shippers 별 몇개의 주문이 처리되었는지 선적사 이름과 주문 카운터 출력
